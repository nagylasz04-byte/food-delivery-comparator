...
- Admin: a `admin.py` fájlokban regisztráljuk a modelleket. Az admin felületet kiegészítjük egyedi `ModelAdmin` osztályokkal, ahol szükséges jogosultság-ellenőrzést végzünk (lásd RBAC rész).
